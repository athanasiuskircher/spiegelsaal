/*
 ...
 x r a -> read analog pins
 x r d -> read digital pins
 x w d [pin] [value] -> write digital pin
 x w a [pin] [value] -> write analog pin
 x p m [pin] [value] -> set pin mode
